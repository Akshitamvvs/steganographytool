...
def handle_file(val):    #function added 
    if val == 'false':
        ...
        choice = raw_input()
        while(choice != '1'):
            print("\n\nWrong raw_input. Enter 1 or ctrl+c to exit.\n")
            choice = raw_input()
        print("enter the key")
        key_val = raw_input()
...
def get_data():
    while(True):
        ...
        if choice == '1':
            ...
            text1 = raw_input()
            return text1.lower().encode('utf-8')
        elif choice == '2':
...
def main():
    ...
    while(choice3 !='1' and choice3 !='2'):   #while loop added
        print("\n\nWrong raw_input. Enter 1 or 2 or ctrl+c to exit.\n")
        choice3 = raw_input()
    if choice3 == '2':   # if loop added
        ...
        while(choice != 'y' and choice != 'n'):
            print("\n\nWrong raw_input. Enter y or n or ctrl+c to exit.\n")
            choice = raw_input()
        if choice == 'y':
            put_key(key)
            print ("\nDone.\n\n")
